    ...
    <div class="container">
                ...
                <a href="{{ route('admin.bookings.index', ['status' => 'new']) }}" class="text-dark">
                    <div class="info-box elevation-2">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Đặt chỗ mới</span>
            ...
            <div class="col-sm-12 col-md-6 col-lg-3">
                <a href="{{ route('admin.rides.index', ['state' => 'active']) }}" class="text-dark">
                    <div class="info-box elevation-2">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Chuyến đi</span>
            ...
            <div class="col-sm-12 col-md-6 col-lg-3">
                <a href="{{ route('admin.routes.index') }}" class="text-dark">
                    <div class="info-box elevation-2">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Tuyến đường</span>
            ...
            <div class="col-sm-12 col-md-6 col-lg-3">
                <a href="{{ route('admin.users.index') }}" class="text-dark">
                    <div class="info-box elevation-2">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Người dùng đã đăng ký</span>
        ...
        <div class="row mt-4">
            <div class="col-md-12 col-lg-7 col-xl-8 mb-4">
                <div class="card card-outline card-indigo elevation-2 h-100">
                    <div class="card-header">
                        <h4 class="card-title">Đặt chỗ trong vòng 6 tháng</h4>
                    ...
                    <div class="card-footer row">
                        ...
                        <div class="col-4 text-center">
                            ...
                            <span class="">Tổng lượt đặt chỗ</span>
                        </div>
                        <div class="col-4 text-center">
                            <h5 class="mb-0">
                                <strong>
                            ...
                            <span class="">Trung bình hàng tháng</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-12 col-lg-5 col-xl-4 mb-4">
                <div class="card card-outline card-indigo elevation-2 h-100">
                    <div class="card-header">
                        <h4 class="card-title">Tuyến đi có nhiều chuyến đi</h4>
                        <div class="card-tools">
                            <button type="button" class="btn btn-tool" data-card-widget="maximize">
                                <i class="fas fa-expand"></i>
                            </button>
